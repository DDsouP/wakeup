...
class TextAdapter(val context: DashboardFragment, private val memorysList: MutableList<Uri>):
    RecyclerView.Adapter<TextAdapter.ViewHolder>(){

    inner class ViewHolder(view: View): RecyclerView.ViewHolder(view){
        val imageView: ImageView = view.findViewById(R.id.textimgView)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.textimg_item, parent, false)
